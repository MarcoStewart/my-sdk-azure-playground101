...
async function main() {
  ...
  const account = process.env.ACCOUNT_NAME || "mysdk101";
  const accountKey = process.env.ACCOUNT_KEY || "0dMTxiGRtHvNAQdZ9tCteTzV6klIKANOzcag0mVHsuwnVKZomy+cDagN40+dp1xc3RnLyIejvXUd+ASt6upcRg==";
